                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left"
                                           novalidate="" modelAttribute="dichVu" method="post" action="/admin/DichVu/DanhSachDichVu/addDichVu/${madv}">
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Mã dịch vụ
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <form:hidden path="madv"/>
                                            <p id="last-name" class="form-control">${dichVu.madv}</p>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <form:input type="text" path="tendv" class="form-control"/>
