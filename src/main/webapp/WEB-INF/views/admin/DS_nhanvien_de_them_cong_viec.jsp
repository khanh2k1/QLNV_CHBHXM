                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 ">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    <h4>
                                                        <a href="${pageContext.request.contextPath}/admin/CongViec/DanhSachCongViec/ThemCongViec/DanhSachBangGia"
                                                        ...
                                                        <div class="col-sm-12">
                                                            <table id="datatable"
                                                                ...
                                                                <c:forEach items="${listNhanVien}" var="nv">
                                                                    <tr onclick="location.href='/admin/CongViec/DanhSachCongViec/ThemCongViec/DanhSachBangGia/${madg}/DanhSachNhanVien/${nv.maNV}';">
                                                                        <td>${nv.maNV}</td>
                                                                        <td>${nv.hoten}</td>
                                                                        <td>${nv.ngaysinh}</td>
                                                                        <td>${nv.luongcoban}</td>
