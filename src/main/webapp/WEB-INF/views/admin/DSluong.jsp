                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="card-box table-responsive">
                                                <form:form
                                                        action="${pageContext.request.contextPath}/admin/Luong/DanhSachLuongTheoThang/${thang_nam_songaythuclam.thang}_${thang_nam_songaythuclam.nam}"
                                                        ...
                                                        <c:forEach items="${listLuongNhanVienTheoThang}"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="/admin/Luong/DanhSachLuongTheoThang/${l.manv}/${thang_nam_songaythuclam.thang}/${thang_nam_songaythuclam.nam}/${l.songaythuclam}">
