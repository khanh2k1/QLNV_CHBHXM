...
<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="/nhanvien/home" class="site_title"><p style="font-weight: 700; font-size: 20px">QUẢN LÝ NHÂN VIÊN</p></a>
        </div>
            ...
            <div class="menu_section active">
                ...
                <ul class="nav side-menu" style="">
                    ...
                    <li><a><i class="fa fa-table"></i> Danh sách <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="">
                            <li><a href="/DanhSachNhanVien">Danh sách nhân viên</a></li>
                            <li><a href="tables_dynamic.html">Danh sách dịch vụ</a></li>
                            <li><a href="tables.html">Danh sách công việc</a></li>
                            <li><a href="tables_dynamic.html">Danh sách loại xe</a></li>
                            <li><a href="tables_dynamic.html">Danh sách năng lực</a></li>
                        </ul>
                    </li>
