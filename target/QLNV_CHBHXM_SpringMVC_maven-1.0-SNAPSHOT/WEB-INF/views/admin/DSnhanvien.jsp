                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 ">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    <h4>
                                                        <a href="${pageContext.request.contextPath}/admin/NhanVien/DanhSachNhanVien/addNhanVienQuanLi"
                                                           class="btn btn-primary" style="font-weight: 700">THÊM
                                                            NHÂN VIÊN QUẢN LÍ</a>
                                                        <a href="${pageContext.request.contextPath}/admin/NhanVien/DanhSachNhanVien/addNhanVienSuaChua"
                                                           class="btn btn-primary" style="font-weight: 700">THÊM
                                                            NHÂN VIÊN SỬA CHỮA</a>
                                                    </h4>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="x_content">
                                                            ...
                                                            <table id="datatable"
                                                                ...
                                                                <tr role="row">
                                                                    ...
                                                                    <th class="sorting" tabindex="0"
                                                                        ...
                                                                        colspan="1"
                                                                        aria-label="Position: activate to sort column ascending"
                                                                        style="width: 250px;">Lương cơ bản
                                                                    </th>
                                                                    <th class="sorting_asc" tabindex="0"
                                                                        aria-controls="datatable" rowspan="1"
                                                                        colspan="1" aria-sort="ascending"
                                                                ...
                                                                <c:forEach items="${listNhanVien}" var="nv">
                                                                    <tr onclick="location.href='/admin/NhanVien/DanhSachNhanVien/editNhanVien/${nv.maNV}';">
                                                                        <td>${nv.maNV}</td>
                                                                        <td>${nv.hoten}</td>
