                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form
                                        ...
                                        action="/admin/TaiKhoan/DanhSachTaiKhoan/editTaiKhoan/${maTK}"
                                        method="post">
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Mật khẩu
                                    ...
                                    <div class="item form-group">
                                        <div class="col-md-6 col-sm-6 offset-md-3">
                                            <a type="button" class="btn btn-primary" onclick="showWarning('/admin/TaiKhoan/DanhSachTaiKhoan')" style="color: white">Trở về</a>
