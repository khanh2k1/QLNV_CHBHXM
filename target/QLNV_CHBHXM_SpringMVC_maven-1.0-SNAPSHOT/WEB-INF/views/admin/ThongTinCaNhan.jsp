                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form id="demo-form2"
                                           ...
                                           method="post"
                                           action="/NhanVienQuanLi/editNhanVien/${nhanVien.maNV}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            ...
                                            <form:input type="date" path="ngaysinh" id="first-name" class="form-control"/>
                                    ...
                                    <div class="item form-group">
                                        <div class="col-md-6 col-sm-6 offset-md-3">
                                            <a href="/NhanVienQuanLi/DanhSachNhanVien" class="btn btn-primary">Trở về</a>
