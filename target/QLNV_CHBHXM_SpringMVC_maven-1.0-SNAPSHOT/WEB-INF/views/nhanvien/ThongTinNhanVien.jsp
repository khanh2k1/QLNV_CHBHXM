                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form id="demo-form2"
                                           ...
                                           method="post"
                                           action="/nhanvien/NhanVien/editNhanVien/${nhanVien.maNV}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            ...
                                            <p class="form-control">${nhanVien.trangthai}</p>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            ...
                                            <p class="form-control">${tenLoaiNV}</p>
                                        </div>
                                    </div>
                                    <div class="item form-group">
...
<%--                                            <fmt:formatDate value="${nv.ngaysinh}" pattern="dd-MM-yyyy"/>--%>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <form:hidden path="luongcoban"/>
                                            <p class="form-control">${nhanVien.luongcoban}</p>
